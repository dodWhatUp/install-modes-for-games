...
Native controls and original combat. Start with the smallest supported set. Difficulty and exact conflicts are detailed in the comparison guide; test each added layer before continuing a valued save.

## After familiarity

Native co-op and New Game+ as appropriate. Expected benefits are qualitative. Keep alternate file/configuration owners in separate profiles and retain a restore point.

## Post-game / replay / experimental

Owned Razmi challenges; no verified large community expansion. Persistent classes, quests, progression and overhauls need a dedicated new/copy save. No additional purchase is assumed.
